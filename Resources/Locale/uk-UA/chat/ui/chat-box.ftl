...
hud-chatbox-info-cycle = Натисніть тут, щоб поговорити, {$cycle-key}, щоб змінити канали.
...
hud-chatbox-select-channel-OOC = [[0]] [[1]]
...
hud-chatbox-highlights = Основні моменти:
hud-chatbox-highlights-button = Надіслати
hud-chatbox-highlights-tooltip = Слова потрібно розділяти символом нового рядка,
