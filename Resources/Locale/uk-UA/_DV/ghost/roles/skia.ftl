...
ghost-role-information-skia-description = Доля перерізала нитку душі, вистежує тіні, щоб знайти їх і пожинати те, що належить.
ghost-role-information-skia-rules = Ви [color=red][bold]один антагоніст[/bold][/color].
...
skia-resurrecting-desc = [color=red]Їхня форма змінюється, схоже, вони намагаються змінитися![/color]