ghost-role-information-synthesis-name = Спеціаліст з синтезу
ghost-role-information-synthesis-description = Ви є членом Interdyne Pharmaceutics! Вам надано всі інструменти для виготовлення різноманітних лікувальних коктейлів. Створіть своє ремесло, продавайте свої отрути та отримуйте прибуток.
ghost-role-information-synthesis-rules = You are a [color=yellow][bold]Free-Agent[/bold][/color].  You are free to act as either an antagonist or a non-antagonist.
