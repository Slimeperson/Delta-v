...
survivor-role-greeting = Ви вижили. Перш за все, вам потрібно повернутися до Центрального командування живим.
...
wizard-role-greeting = Настав час чарівника, вогненна куля!
