...
conspirator-role-greeting = Ви змовник.
...
conspirator-count = Працюйте зі своїми колегами-змовниками, щоб втілити змову в життя.
...
conspirator-name = {$name}— змовник.
conspirator-radio-implant = Спілкуйтеся з іншими змовниками за допомогою свого радіоімплантату (:o).

conspiracy-title = Змова
conspiracy-description = Діє змова!