health-analyzer-window-entity-unborgable-text = [color=red]Сигнатури мозку пацієнта несумісні з технологією MMI![/color]
health-analyzer-window-entity-redshirt-text = [color=red]Пацієнт не має критичного стану, який можна відновити; пошкодження має бути менше 100 балів для дефібриляції.[/color]
health-analyzer-window-entity-uncloneable-text = [color=orange]Пацієнт має аномальну структуру молекулярного тіла; клонування неможливо.[/color]
