...
objective-condition-fired-person-title = Отримати {$targetName}, {CAPITALIZE($job)} звільнити.

roles-antag-NT-agent-objective = Виконуйте брудну роботу для NanoTrasen.