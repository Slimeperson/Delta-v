...
# TraitorRole
traitor-role-greeting = You are an agent sent by [color = darkred]The Syndicate[/color]від імені {$corporation}.
    ...
    Death to Nanotrasen!
traitor-role-codewords = The codewords are: [color = світло-сірий]
    The codewords are: [color = світло-сірий]
    {$codewords}.[/color]
...
traitor-role-uplink-code = Set your ringtone to the notes [color = світло-сірий]{$code}[/color], щоб заблокувати або розблокувати вихідну лінію.
...
traitor-role-uplink-implant = Ваш імплантат висхідної лінії зв’язку активовано, увійдіть до нього з гарячої панелі.
...
traitor-role-uplink-implant-short = Ваш висхідний канал імплантовано. Доступ до нього з меню дій.